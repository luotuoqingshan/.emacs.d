...
#+RESULTS:
| global-font-lock-mode-check-buffers | global-eldoc-mode-check-buffers | evil-mode-check-buffers | global-evil-collection-unimpaired-mode-check-buffers | global-undo-tree-mode-check-buffers | global-display-line-numbers-mode-check-buffers | global-company-mode-check-buffers | magit-auto-revert-mode-check-buffers | my-yas-try-expanding-auto-snippets | evil-repeat-post-hook | gcmh-register-idle-gc |
